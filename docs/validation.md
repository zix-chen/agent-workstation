...
- 63 automated tests passed under each Python version, including real stdio handshake/tool calls and loopback HTTP bearer auth.
...
Version 0.1.1 removes reverse DNS from fixed-loopback binding in both the MCP listener and demo fixture and adds bind/readiness regressions.
